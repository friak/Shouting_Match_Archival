...
void loop() {
  ...
  if (volts >= 2 && volts <= 2.9 && joystick.getVertical() == 496 && joystick.getHorizontal() == 500) {
  ...
  if (volts >= 3 && volts <= 3.9 && joystick.getVertical() == 496 && joystick.getHorizontal() == 500) {
  ...
  if (volts >= 4.0  && joystick.getVertical() == 496 && joystick.getHorizontal() == 500) {
    digitalWrite(ledPin, HIGH);
